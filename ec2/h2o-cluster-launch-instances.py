...
ansibleHostsFileName = 'hosts'
if not dryRun:
    fpublic = open(publicFileName, 'w')
    fprivate = open(privateFileName, 'w')
    fhosts=open(ansibleHostsFileName,'w')
...
print
print 'Creating output files: ', publicFileName, privateFileName,ansibleHostsFileName
print
...
for i in range(numInstancesToLaunch):
    ...
    fhosts.write(instance.private_ip_address+'\n')
